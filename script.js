...
document.write("U heeft gekozen voor"," ", small," ", "small pizza(s).", " ","€", small*SPRICE, ",-");
document.write("<br><br>");		//deze "<br><br>" staat voor een dubble ENTER.
document.write("U heeft gekozen voor"," ", medium," ", "medium pizza(s).", " ","€", medium*MPRICE, ",-");
document.write("<br><br>");
document.write("U heeft gekozen voor"," ", large," ", "large pizza(s).", " ","€", large*LPRICE, ",-");
